...
public class MapCNTower extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_c_n_tower);
    ...
    public OnMapReadyCallback onMapReadyCallback1(){
        return new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                LatLng cnTower = new LatLng(43.6420312,-79.3894118);
                mMap.addMarker(new MarkerOptions().position(cnTower).title("Marker in CN Tower"));
