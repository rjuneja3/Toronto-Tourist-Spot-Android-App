...
public class MapRoyalMuseum extends FragmentActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_royal_museum);
    ...
    public OnMapReadyCallback onMapReadyCallback1(){
        return new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                LatLng royal = new LatLng(43.6676298,-79.3949405);
                mMap.addMarker(new MarkerOptions().position(royal).title("Marker in Royal Museum"));
                mMap.moveCamera(CameraUpdateFactory.newLatLng(royal));
                mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(royal,16));
